<div class="container-fluid">
    ...
    <table class="table table-bordered">
    	<tr class="text-center" bgcolor="#232e3c">
    		<th>NO</th>
    		<th>NAMA BARANG</th>
    		<th>KETERANGAN</th>
    		<th>KATEGORI</th>
       ...
       <tr>
       	 ...
       	 <td onclick="javascript: return confirm('Anda yakin hapus?')"><?php echo anchor('admin/data_barang/hapus/' .$brg->id_brg, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>
